...
class ProjectsRepository(private val db: MechForgeDatabase) {
    ...
    fun info(id: Long): ProjectInfo? =
        db.projectsQueries.selectProjectById(id).executeAsOneOrNull()?.let { row ->
            ProjectInfo(
                ...
                calculationPackage = row.calculation_package.orEmpty(),
                drawingReference = row.drawing_reference.orEmpty(),
                specificationReference = row.specification_reference.orEmpty(),
                ...
                projectSpecification = row.project_specification.orEmpty(),
                designStandard = row.design_standard.orEmpty(),
    ...
    fun saveInfo(id: Long, info: ProjectInfo) {
        db.projectsQueries.updateProjectInfo(
            ...
            department = info.department.blankToNull(),
            calculation_package = info.calculationPackage.blankToNull(),
            drawing_reference = info.drawingReference.blankToNull(),
            specification_reference = info.specificationReference.blankToNull(),
            ...
            project_specification = info.projectSpecification.blankToNull(),
            design_standard = info.designStandard.blankToNull(),
