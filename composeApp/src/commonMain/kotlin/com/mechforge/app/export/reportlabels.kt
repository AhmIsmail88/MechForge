...
data class ReportLabels(
    ...
    val registerSummary: String,
    val registerTotal: String,
    val registerNoStatus: String,
    val registerEntries: String,
    val registerCalcNo: String,
    ...
    companion object {
        val ENGLISH = ReportLabels(
            ...
            registerTitle = "Project calculation register",
            registerSummary = "Status summary",
            registerTotal = "Total calculations",
            registerNoStatus = "No status",
            registerEntries = "Calculations",
            registerCalcNo = "Calc. no.",
        ...
        val ARABIC = ReportLabels(
            ...
            registerTitle = "سجل حسابات المشروع",
            registerSummary = "ملخص الحالات",
            registerTotal = "إجمالي الحسابات",
            registerNoStatus = "بدون حالة",
            registerEntries = "الحسابات",
            registerCalcNo = "رقم الحساب",
